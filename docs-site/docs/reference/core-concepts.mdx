...
| `QuestionResponse` | `turn_id`, `tool_use_id`, `reply` | Resolve a structured question prompt asked by `AskUser` |
...
| `TurnPause` | `turn_id`, `reason` | Turn paused (e.g. waiting for tool approval or answers to structured questions) |
