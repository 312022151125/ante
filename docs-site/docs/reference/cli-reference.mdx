...
| `--version <VERSION>` | Install an exact release instead of the channel's newest release. Accepts values with or without a leading `v`, such as `v0.2.0` or `0.2.0`. Conflicts with channel arguments. |
| `-h`, `--help` | Print command help. |
