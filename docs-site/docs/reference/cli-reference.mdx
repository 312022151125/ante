...
Gateway mode connects Ante to Slack, Discord, or both using the channels config file. It connects to a running Ante host via the SDK rather than managing an in-process runtime.
