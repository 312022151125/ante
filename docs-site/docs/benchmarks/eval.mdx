...
- **Ante + DeepSeek V4.1 Flash reaches 83.9%**: 370/445 trials under official Terminal-Bench 2.1 constraints, for about $18 of inference across the full run.
- **Ante + GLM 5.2 at 74.6%** places in the top tier of the public verified leaderboard with an open-weight model.
...
Capability is half the story; cost to run is the other half. See [Resource Footprint](/benchmarks/compare_table) for Docker-measured CPU, memory, and disk usage across 20 parallel tasks — Ante vs Claude Code vs Opencode.
