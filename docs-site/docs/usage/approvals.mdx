...
<img src="/assets/cookbook/approval.gif" alt="Reviewing and approving a tool call" className="cookbook-demo" />
...
<img src="/assets/cookbook/automode.gif" alt="Switching Ante permission modes and running in Auto mode" className="cookbook-demo" />
