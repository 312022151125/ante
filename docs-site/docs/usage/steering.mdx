...
<img src="/assets/cookbook/interrupt.gif" alt="Interrupting the agent" className="cookbook-demo" />
...
<img src="/assets/cookbook/steering.gif" alt="Steering a running Ante turn with queued guidance" className="cookbook-demo" />
...
When you replace the session by starting a new one or resuming another, queued messages return to the composer so you can review and resubmit them.
